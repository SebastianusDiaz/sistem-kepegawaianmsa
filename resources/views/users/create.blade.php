            ...
            <div class="space-y-6">
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-6 mt-4">
                                ...
                                @enderror
                                <p class="mt-2 text-xs text-gray-500">Klik pada kartu untuk memilih role (bisa pilih lebih
                                    dari satu).</p>
                            </div>
                ...
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            {{-- NIP --}}
                            <div class="sm:col-span-3">
                                <label for="nip" class="block text-sm font-medium text-gray-700">Nomor Induk Pegawai
                                    (NIP)</label>
                                <div class="mt-1">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <textarea id="address" name="address" rows="3"
                                        class="shadow-sm focus:ring-orange-500 focus:border-orange-500 block w-full sm:text-sm border-gray-300 rounded-lg"
                ...
                <div class="flex justify-end gap-x-3 pt-4">
                    <a href="{{ route('users.index') }}"
                        class="rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-colors">
                        Batal
                    </a>
                    <button type="submit"
                        class="inline-flex justify-center rounded-lg border border-transparent bg-orange-600 px-6 py-2 text-sm font-medium text-white shadow-sm hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-all transform hover:-translate-y-0.5">
