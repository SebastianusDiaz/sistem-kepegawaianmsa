                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($divisions as $division)
                            <tr class="group hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium {{ $division->users_count > 0 ? 'bg-blue-50 text-blue-700 ring-1 ring-inset ring-blue-600/20' : 'bg-gray-50 text-gray-600 ring-1 ring-inset ring-gray-500/10' }}">
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">Silakan tambahkan departemen baru ke dalam sistem.</p>
                                        <div class="mt-4">
                                            <a href="{{ route('divisions.create') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                                                + Tambah Data
                                            </a>
                                        </div>
                                    </div>
